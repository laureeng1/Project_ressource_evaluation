...
define(['app', 'utilities', 'angular-dialog-service', 'dev-eval-services', 'dev-eval-modal-services'], function (app) {
    ...
    app.controller('prolongationActionModalCtrl', [
       '$scope',
       '$modalInstance',
       '$rootScope',
       'commonUtilities',
       ...
       function ($scope, $modalInstance, $rootScope, commonUtilities, moduleServiceWeb, erpDialogs, erpModels, data) {
           ...
           $scope.item.actionType = 'prolongation';
           ...
           $scope.save = function (itemToSave) {
               if ($scope.DoSaveItem) {
                   ...
                   var params = new commonUtilities.RequestSw(0, 1, false, 1, true, "Prolongation d'une tâche", 'Prolongation effectué avec succès!', true);
                   //console.log(params);
