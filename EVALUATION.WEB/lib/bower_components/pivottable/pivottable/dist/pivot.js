    ...
    callWithJQuery(function ($) {
        ...
        aggregators = (function (tpl) {
            return {
                ...
                "Ecart d'echantillon": tpl["var"](1, usFmt),
                "Ecart-type de l'echantillon": tpl.stdev(1, usFmt),
                "Minimum": tpl.min(usFmt),
                "Maximum": tpl.max(usFmt),
                "Premier": tpl.first(usFmt),
                "Dernier": tpl.last(usFmt),
                "Ratio de sommes": tpl.sumOverSum(usFmt),
                "Borne superieure 80%": tpl.sumOverSumBound80(true, usFmt),
                "Borne inferieure 80%": tpl.sumOverSumBound80(false, usFmt),
        ...
        renderers = {
            ...
            "Table avec barres": function (data, opts) {
        ...
        locales = {
            en: {
                ...
                renderers: renderers,
                localeStrings: {
                    renderError: "Une erreur est survenue en dessinant le tableau croise.",
                    computeError: "Une erreur est survenue en calculant le tableau croise.",
                    uiRenderError: "Une erreur est survenue en dessinant l'interface du tableau croise dynamique.",
