    ...
    function ReportViewerController(options) {
        ...
        function printReport() {
            ...
            exportAsync("PDF", {
                ...
                //document.body.innerHTML = "<html><head><title></title></head><body> <img src= " + url + "/></body>";
                //document.body.innerHTML = "<IFRAME src='" + url + "' name=zone_1 width=100% height=97% scrolling=auto frameborder=0 > </IFRAME>";
                //window.open(document, "_self");
                //window.print();
                
                /*var conteneurPDF = '<object data="'+ url +'" type="application/pdf" width="300" height="200">alt : <a href="data/test.pdf">test.pdf</a></object>';
                document.body.innerHTML = $.parseHTML("<html><head><title></title></head><body>" + conteneurPDF + "</body>");
                window.print();
                document.body.innerHTML = originalContents;*/

                console.log(url);
                var conteneurPDF = '<object data="' + url + '" type="application/pdf" width="100%" height="100%">alt : <a href="data/test.pdf">test.pdf</a></object>';
                document.body.innerHTML = "<html><head><title></title></head><body>" + conteneurPDF + "</body></html>";
                window.print();
                document.body.innerHTML = originalContents;
                /*$.ajax({
                    type: 'GET',
                    ...
                    success: function (data) {
                        alert("requete aboutie");
                        console.log(data);
                        
                        var conteneurPDF = '<object data="' + data + '" type="application/octet-stream" width="100%" height="100%">alt : <a href="data/test.pdf">test.pdf</a></object>';
                        document.body.innerHTML = "<html><head><title></title></head><body>" + conteneurPDF + "</body></html>";
                        window.print();
                        document.body.innerHTML = originalContents;
                    },
