...
function () {
    ...
    'use strict';
        ...
        var app = angular.module('app', [
                ...
                [
                    '$rootScope', '$state', '$stateParams', '$http', 'commonUtilities', '$idle',
                function ($rootScope, $state, $stateParams, $http, commonUtilities, $idle) {                    
                        ...
                        // remarque : les transform sont exécutés avant les intercepteurs
            ...
            .config(
                ...
                function ($keepaliveProvider, $idleProvider) {
                        ...
                        //    return userParse.TimeSession;
                        //};

                        //var timeOut = getTimeSession();
                        //$idleProvider.idleDuration(timeOut);
                        //$idleProvider.warningDuration(15);
                        ////$keepaliveProvider.interval(10);

                        $idleProvider.idleDuration(600); //seconde 
                        $idleProvider.warningDuration(15);
                        //$keepaliveProvider.interval(10);
                    }
                ]
                                ...
                                "nav": {
                                    ...
                                    "components": {
                                        ...
                                        "ui_kits": {
                                            ...
                                            "IMALI_TRESO": "Imali Tréso",
                                            "MOYENS_GENERAUX": "Moyens généraux",
                                            "SUIVI_BUDGETAIRE": "Suivi budgétaire",
                                            "CLINIQUE": "Clinique",
            ...
            function ($stateProvider, $urlRouterProvider) {
                    ...
                    $stateProvider
                        ...
                        .state('access.signin', {
                            ...
                            templateUrl: HelpersErp.getUrlByFrmMainviewsBase('signin/page_signin.html', MODULE_ERP_ADMIN),
                            resolve: {
                                loadMyCtrl: [
                                '$ocLazyLoad', function ($ocLazyLoad) {
                                        // you can lazy load files for an existing module
                                        return $ocLazyLoad.load({
                                            files: [HelpersErp.getUrlByFrmMainviewsBase('signin/controllers.js', MODULE_ERP_ADMIN)]
                                        });
                                    }
                                ]
                            }
